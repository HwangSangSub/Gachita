				...
				if ($totalCnt < 1) { //없을 경우
					...
					while ($n = $nqStmt->fetch(PDO::FETCH_ASSOC)) {
						...
						$mresult = ["boardId" => (int)$board_id, "idx" => (int)$nbNIdx, "bNot" => $bNot, "bChk" => $nbChk, "title" => (string)$nsubject, "regDate" => (string)$nRegDate, "conTent" => (string)$nContent];
