...
$con_Price1 = str_replace(',', '', trim($conPrice1));
$con_Price2 = str_replace(',', '', trim($conPrice2));
$con_Price3 = str_replace(',', '', trim($conPrice3));
$con_Tax = str_replace(',', '', trim($conTax));

$DB_con = db1();

if ($mode == "reg") {

	$insQuery = "INSERT INTO TB_CONFIG_EXC (con_Tax ) VALUES (:con_Tax)";
	...
	$upQquery = "UPDATE TB_CONFIG_EXC SET con_Tax = :con_Tax  WHERE  idx = :idx  LIMIT 1";
