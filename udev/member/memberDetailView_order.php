<?
	...
	$sql_search=" WHERE taxi_OMemIdx='".$idx."' ";
...
<div id="wrapper">
    <div id="container" class="">
        ...
        <h1 id="container_title"><?= $sqlRow['mem_Id']?>(<?=$sqlRow['mem_NickNm']?>)&nbsp;회원상세보기 - 주문내역</h1>
		...
		<div class="local_ov01 local_ov">
			<span class="btn_ov01">
				...
				<span class="ov_txt"><a href="memberDetailView_order.php?idx=<?=$idx?>">주문내역</a></span>
