...
$sql_search = " WHERE A.taxi_MemIdx = '".$idx."' ";
...
<div id="wrapper">
    <div id="container" class="">
		...
		<h1 id="container_title"><?= $sqlRow['mem_Id']?>(<?=$sqlRow['mem_NickNm']?>)&nbsp;회원상세보기 - 매칭관리</h1>
		...
		<div class="local_ov01 local_ov">
			<span class="btn_ov01">
				...
				<span class="ov_txt"><a href="memberDetailView_taxiSharingList.php?idx=<?=$idx?>">매칭내역</a></span>
...
-->
   ...
   <?
    ...
    <tr class="<?=$bg?>">
        ...
        <td headers="mb_list_id"><a href="/udev/taxiSharing/taxiSharingSList.php?taxiSIdx=<?=$row['idx']?>" class="btn btn_05">투게더</a></td>
