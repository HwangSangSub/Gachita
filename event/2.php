...
* 프로그램			: 미션 상세 페이지 (웹뷰)
* 페이지 설명		: 가치타 인스타그램 맞팔해요 (TB_MISSION 테이블에 idx 번호)
* 파일명            : 2.php
...
<body>
    <div class="du01">
        ...
        ?>
            <div class="title">
                <div class="text">가치타 인스타그램 팔로워하면<BR><?= number_format($m_SPoint) ?>원을 드려요</div>
            ...
            <div class="content">
                <div class="content_pre">
                    <div class="content_Img">
                        <img src="img/2.jpg" alt="2.jpg" style="width: 100%;">
                    </div>
