...
* 프로그램			: 미션 상세 페이지 (웹뷰)
* 페이지 설명		: 가치타 카카오채널 친구맺기 (TB_MISSION 테이블에 idx 번호)
* 파일명            : 1.php
...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // 김대리와 상의 후 폰트 사이즈 크기 조절 안하기로 처리함 2023-07-13
            // if (isMobile) {
...
<body>
    <div class="du01">
        ...
        ?>
            <div class="title">
                <div class="text">가치타 카카오톡 친구추가하면<BR><?= number_format($m_SPoint) ?>원을 드려요</div>
            ...
            <div class="content">
                <div class="content_pre">
                    <div class="content_Img">
                        <img src="img/1.jpg" alt="1.jpg" style="width: 100%;">
                    </div>
                    <div class="content_Button">
                        <a href="javascript:;"><button class="button_Give"><?= number_format($m_SPoint) ?>원 받기</button></a>
                        <a href="javascript:;"><button class="button_Do">참여하기</button></a>
                    </div>
                </div>
            </div>
        <?
    ...
    <div class="footer">
        ...
        <div>
            ...
            <div>
                <div><img src="img/disc.png" alt="disc.png"></div>
                <div>해당 미션 수행 완료 후 ‘<?= number_format($m_SPoint) ?>원 받기’ 버튼을 클릭한 경우에만 지급됩니다.</div>
            </div>
            <div>
                <div><img src="img/disc.png" alt="disc.png"></div>
