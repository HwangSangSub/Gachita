...
* 프로그램			: 미션 상세 페이지 (웹뷰)
* 페이지 설명		: 투게더 같이타기 신청하기 (TB_MISSION 테이블에 idx 번호)
* 파일명            : 7.php
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.button_Give').click(function() {
                ...
                location.href = guideUrl+"?id=content_Together";
            });
...
<body>
    <div class="du01">
        ...
        ?>
            <div class="title">
                <div class="text">내 주변에 등록된 같이타기,<BR>신청만 해도 포인트 지급</div>
            ...
            <div class="content">
                <div class="content_pre">
                    <div class="content_Img">
                        <img src="img/7_1.jpg" alt="7_1.jpg" style="width: 100%;">
                        <img src="img/7_2.jpg" alt="7_2.jpg" style="width: 100%;">
                    </div>
                    <div class="content_Button">
                        <a href="javascript:;"><button class="button_Give">투게더 가이드</button></a>
                        <a href="javascript:;"><button class="button_Do">같이타기 신청하기</button></a>
                    </div>
                </div>
            </div>
        <?
    ...
    <div class="footer">
        ...
        <div>
            ...
            <div>
                <div><img src="img/disc.png" alt="disc.png"></div>
                <div>이용 완료를 하지 않더라도 같이타기 신청 완료시 포인트는 즉시 지급되며, 지급된 포인트는 [메뉴]→[내 포인트]에서 확인할 수 있습니다.</div>
            </div>
            <div>
                <div><img src="img/disc.png" alt="disc.png"></div>
