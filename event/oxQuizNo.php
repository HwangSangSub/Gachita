...
* 프로그램			: 오늘의 OX 오답인 경우 페이지 (웹뷰)
* 페이지 설명		: 오늘의 OX 오답인 경우 페이지 (웹뷰)
* 파일명            : oxQuizYes.php
...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //     // 각 요소의 스타일 수정하기
            //     var totalRate = ((window.innerWidth / 375) + (window.innerHeight / 667)) / 2;
...
<body>
    <div class="du01">
        ...
        <div class="line"></div>
        <div class="ans_title">
            <div class="ans_text">땡~ 오답</div>
            <div class="ans_memo">정답은 <?= $oxAnswer ?>, 10원을 지급해드렸어요!</div>
            <div class="ans_face"><img src="./img/face_No.gif" /></div>
            <div class="ans_exp">
