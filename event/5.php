...
* 프로그램			: 미션 상세 페이지 (웹뷰)
* 페이지 설명		: 대단해요 탐험가 등급 달성 (TB_MISSION 테이블에 idx 번호)
* 파일명            : 5.php
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.button_Give').click(function() {
                var url = $("#url").val();
                window.flutter_inappwebview.callHandler('push', false, url);
            });
...
<body>
    <div class="du01">
        ...
        ?>
            <div class="title">
                <div class="text">대단해요 탐험가 등급 달성<BR>5회 이상만 이용하면 UP!</div>
            ...
            <div class="content">
                <div class="content_pre">
                    <div class="content_Img">
                        <img src="img/5.jpg" alt="5.jpg" style="width: 100%;">
                    </div>
                    <div class="content_Button">
                        <a href="javascript:;"><button class="button_Give">내 등급 보기</button></a>
                        <a href="javascript:;"><button class="button_Do"> <?= number_format($m_SPoint) ?>원 받기</button></a>
                    </div>
                </div>
            </div>
        <?
    ...
    <div class="footer">
        ...
        <div>
            ...
            <div>
                <div><img src="img/disc.png" alt="disc.png"></div>
                <div>해당 미션은 당월 조건(같이타기 5회 이상 이용) 달성 완료 후, <?= number_format($m_SPoint) ?>원 받기 버튼을 클릭한 경우 익월 1일에 자동 지급됩니다</div>
            </div>
            <div>
                <div><img src="img/disc.png" alt="disc.png"></div>
                <div>조건 달성을 완료했다면 미션은 완료로 표시되며, 지급일 이전까지 [메뉴]→[내 포인트]→[적립 예정] 내역에서 지급 예정일등 상세 내용을 확인하실 수 있습니다.</div>
            </div>
            <div>
                <div><img src="img/disc.png" alt="disc.png"></div>
                <div>1일에 지급 완료된 포인트는 [메뉴]→[내 포인트]에서 내역을 확인할 수 있으며,  경우에 따라서 지급 시간이 지연될 수 있습니다.</div>
            </div>
            <div>
                <div><img src="img/disc.png" alt="disc.png"></div>
